...
const TypeTitle = { fontSize: "24px", color: "#1985A1", fontWeight:'600' , paddingRight: "25px"};
...
export const TabsData = [
  {
    ...
    colSpan: 4,
    features: (
      <Text style={TypeTitle}> {PRICE_DATA.shopFeature} </Text>
    ),
  },
  {
    key: "2",
  ...
  },
  {
    ...
    colSpan: "4",
    features: (
      <Text style={TypeTitle}>{PRICE_DATA.advancedOption}</Text>
    ),
  },
  {
    key: "19",
  ...
  },
  {
    ...
    advanced: renderData("text","5"),
    silver:  renderData("text","10"),
    gold: renderData("text",PRICE_DATA.UNLIMITED),
  },
  {
    key: "28",
  ...
  },
  {
    ...
    colSpan: "4",
    features: (
      <Text style={TypeTitle}>{PRICE_DATA.shoppingTools}</Text>
    ),
  },
  {
    key: "33",
  ...
  },
  {
    ...
    colSpan: "4",
    features: (
      <Text style={TypeTitle}>{PRICE_DATA.services}</Text>
    ),
  },
  {
    key: "45",
  ...
  },
  {
    ...
    colSpan: "4",
    features: (
      <Text style={TypeTitle}>{PRICE_DATA.support}</Text>
    ),
  },
  {
    key: "49",
